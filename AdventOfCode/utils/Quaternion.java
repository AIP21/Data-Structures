...
public final class Quaternion {
    ...
    public static Quaternion fromEulerYxz(float x, float y, float z) {
        ...
        quaternion.hamiltonProduct(new Quaternion(0.0F, (float) Math.sin((double) (x / 2.0F)), 0.0F,
                (float) Math.cos((double) (x / 2.0F))));
        quaternion.hamiltonProduct(new Quaternion((float) Math.sin((double) (y / 2.0F)), 0.0F, 0.0F,
                (float) Math.cos((double) (y / 2.0F))));
        quaternion.hamiltonProduct(new Quaternion(0.0F, 0.0F, (float) Math.sin((double) (z / 2.0F)),
                (float) Math.cos((double) (z / 2.0F))));
        return quaternion;
    }

    public static Quaternion fromEulerXyzDegrees(Vec3f vector) {
        return fromEulerXyz((float) Math.toRadians((double) vector.getX()),
                (float) Math.toRadians((double) vector.getY()), (float) Math.toRadians((double) vector.getZ()));
    }
    ...
    public static Quaternion fromEulerXyz(float x, float y, float z) {
        Quaternion quaternion = IDENTITY.copy();
        quaternion.hamiltonProduct(new Quaternion((float) Math.sin((double) (x / 2.0F)), 0.0F, 0.0F,
                (float) Math.cos((double) (x / 2.0F))));
        quaternion.hamiltonProduct(new Quaternion(0.0F, (float) Math.sin((double) (y / 2.0F)), 0.0F,
                (float) Math.cos((double) (y / 2.0F))));
        quaternion.hamiltonProduct(new Quaternion(0.0F, 0.0F, (float) Math.sin((double) (z / 2.0F)),
                (float) Math.cos((double) (z / 2.0F))));
        return quaternion;
    ...
    public Vec3f toEulerYxz() {
        ...
        return Math.abs(k) > 0.999F * j
                ...
                : new Vec3f(
                        (float) Math.atan2(
                                (double) (2.0F * this.getY() * this.getZ() + 2.0F * this.getX() * this.getW()),
                                (double) (f - g - h + i)),
                        l,
                        (float) Math.atan2(
                                (double) (2.0F * this.getX() * this.getY() + 2.0F * this.getW() * this.getZ()),
                                (double) (f + g - h - i)));
    }

    public Vec3f toEulerYxzDegrees() {
        Vec3f vec3f = this.toEulerYxz();
        return new Vec3f((float) Math.toDegrees((double) vec3f.getX()), (float) Math.toDegrees((double) vec3f.getY()),
                (float) Math.toDegrees((double) vec3f.getZ()));
    }
    ...
    public Vec3f toEulerXyz() {
        ...
        return Math.abs(k) > 0.999F * j
                ...
                : new Vec3f(l,
                        (float) Math.atan2(
                                (double) (2.0F * this.getX() * this.getZ() + 2.0F * this.getY() * this.getW()),
                                (double) (f - g - h + i)),
                        (float) Math.atan2(
                                (double) (2.0F * this.getX() * this.getY() + 2.0F * this.getW() * this.getZ()),
                                (double) (f - g + h - i)));
    ...
    public void normalize() {
        float f = this.getX() * this.getX() + this.getY() * this.getY() + this.getZ() * this.getZ()
                + this.getW() * this.getW();
        if (f > 1.0E-6F) {
