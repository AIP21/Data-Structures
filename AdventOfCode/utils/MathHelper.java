...
public class MathHelper {
    ...
    public static double fastInverseSqrt(double x) {
        double d = 0.5 * x;
        long l = Double.doubleToRawLongBits(x); // evil floating point bit level hacking
        l = 6910469410427058090L - (l >> 1); // what the fuck?
    ...
    // public static ArrayList<Point> pointsOnLine(Point start, Point end) {
