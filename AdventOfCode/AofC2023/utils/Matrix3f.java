...
public final class Matrix3f {
    ...
    private static Quaternion method_22857(Matrix3f matrix) {
        ...
        if (matrix.a01 * matrix.a01 + matrix.a10 * matrix.a10 > 1.0E-6F) {
            pair = getSinAndCosOfRotation(matrix.a00, 0.5F * (matrix.a01 + matrix.a10), matrix.a11);
        ...
        if (matrix.a02 * matrix.a02 + matrix.a20 * matrix.a20 > 1.0E-6F) {
            pair = getSinAndCosOfRotation(matrix.a00, 0.5F * (matrix.a02 + matrix.a20), matrix.a22);
        ...
        if (matrix.a12 * matrix.a12 + matrix.a21 * matrix.a21 > 1.0E-6F) {
            pair = getSinAndCosOfRotation(matrix.a11, 0.5F * (matrix.a12 + matrix.a21), matrix.a22);
            float_ = (Float) pair.getFirst();
            float2 = (Float) pair.getSecond();
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            return Float.compare(matrix3f.a00, this.a00) == 0 && Float.compare(matrix3f.a01, this.a01) == 0
                    && Float.compare(matrix3f.a02, this.a02) == 0 && Float.compare(matrix3f.a10, this.a10) == 0
                    && Float.compare(matrix3f.a11, this.a11) == 0 && Float.compare(matrix3f.a12, this.a12) == 0
                    && Float.compare(matrix3f.a20, this.a20) == 0 && Float.compare(matrix3f.a21, this.a21) == 0
